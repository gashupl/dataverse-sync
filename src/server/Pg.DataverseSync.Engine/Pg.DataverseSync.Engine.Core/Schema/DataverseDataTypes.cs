namespace Pg.DataverseSync.Engine.Core.Schema
{
    public class DataverseDataTypes
    {
        ...
        public const string PartyList = "PartyListType";
        ...
        public const string CalendarRules = "CalendarRulesType";
        public const string Virtual = "VirtualType";
        public const string BigInt = "BigIntType";
        public const string ManagedProperty = "ManagedPropertyType";
        public const string EntityName = "EntityNameType";
        public const string Image = "ImageType";
        public const string MultiSelectPicklist = "MultiSelectPicklistType";
        public const string File = "FileType";
        public const string Custom = "CustomType";
    }
}
